...
<div class="x1-main" style="margin-left:250px">
  ...
  <div class="x1-display-container x1-container">
        <h1 class="x1-titles">Indomitable Shirts</h1>
    <div class="x1-display-topleft x1-padding-xxlarge x1-text-white">
      <h1 class="x1-jumbo x1-hide-small">Our Classics</h1>
      <h1 class="x1-hide-large x1-hide-medium">Recently Updated</h1>
      <h1 class="x1-hide-small">Surf Wear 2017</h1>
      <p><a href="" class="x1-button x1-black x1-padding-large x1-large"></a></p>
    </div>
  </div>
  ...
  <!-- Product grid -->
  <a href="shirts/0001.php">
  <div class="x1-row x1-grayscale">
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <img src="shirts/shirt1.png" style="width:100%"></a><!--Shirt1-->
        <p>World Surf League Polo Unisex<br><b>$34.99</b></p>
      </div>
      <a href="shirts/0002.php"><div class="x1-container">
        <img src="shirts/shirt2.png" style="width:100%"></a><!--Shirt2-->
    ...
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <div class="x1-display-container">
          <img src="shirts/shirt3.png" style="width:100%"><!--Shirt3-->
          <span class="x1-tag x1-display-topleft">New</span>
          <div class="x1-display-middle x1-display-hover">
          </div>
        </div></a>
        <p>Unisex Savage WSL Hoodie<br><b>$49.99</b></p>
      </div>
	  <a href="shirts/0004.php">
      <div class="x1-container">
        <img src="shirts/shirt4.png" style="width:100%"></a><!--Shirt4-->
        <p>Indomitable Running<br><b>$29.99</b></p>
      </div>
    </div>

	<a href="shirts/0005.php">
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <img src="shirts/shirt5.png" style="width:100%"></a><!--Shirt5-->
        <p>Indomitable New Cotton Shirt<br><b>$29.99</b></p>
      </div>
      
	  <a href="shirts/0006.php">
	  <div class="x1-container">
        <div class="x1-display-container">
          <img src="shirts/shirt6.png" style="width:100%"></a><!--Shirt6-->
          <span class="x1-tag x1-display-topleft">Sale</span>
          <div class="x1-display-middle x1-display-hover">
          </div>
        </div>
        <p>HighTech Indomitable Hiker<br><b class="x1-text-red">$26.99</b></p>
      </div>
    </div>

	<a href="shirts/0007.php">
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <img src="shirts/shirt7.png" style="width:100%"></a><!--Shirt7-->
        <p>Vintage Era Indomitable Shirt<br><b>$54.99</b></p>
      </div>
      <a href="shirts/0008.php">
	  <div class="x1-container">
        <img src="shirts/shirt8.png" style="width:100%"></a><!--Shirt8-->
        <p>Crush-Kill-Destroy-Swag<br><b>$34.99</b></p>
      </div>
    </div>
  </div>
