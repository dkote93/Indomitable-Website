...
<p>
  ...
  <img src="1.jpg" width="45%" alt="nameeee" align="left" class="x1-padding-large">
  <h1 class="x1-titles">nameeee</h1>
  <h4>$priceeee</h4>
		<br>
		Our nameeee sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				...
				<select name="os1" id="os1">
					<option value="sunglasses"selected> - One Size Fits All -</option>
				</select>
