...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Rip Tide 2017 Beach Runner";
...
<html>
<title>Rip Tide 2017 Beach Runner - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals3.jpg" alt="Rip Tide 2017 Beach Runner" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Rip Tide 2017 Beach Runner</h1>
  <h4>$29.99</h4>
		<br>
		Our Rip Tide 2017 Beach Runner sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Rip Tide 2017 Beach Runner">
