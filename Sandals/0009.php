...
<html>
<title>David Clark Unisex 2017 - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals1.jpg" width="40%" alt="David Clark Unisex 2017" align="left" class="x1-padding-large">
  <h1 class="x1-titles">David Clark Unisex 2017</h1>
  <h4>$19.99</h4>
		<br>
		Our David Clark Unisex 2017 sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="David Clark Unisex 2017">
				<input type="hidden" name="sku" value="0009">
				...
				<input type="hidden" name="option_amount1" value="19.99">
