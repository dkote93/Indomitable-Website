<!-- Expedition Climb Sand Dwellers -->
...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Expedition Climb Sand Dwellers";
...
<html>
<title>Expedition Climb Sand Dwellers - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals5.jpg" alt="Expedition Climb Sand Dwellers" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Expedition Climb Sand Dwellers</h1>
  <h4>$29.99</h4>
		<br>
		Our Expedition Climb Sand Dwellers sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Expedition Climb Sand Dwellers">
