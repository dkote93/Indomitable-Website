<!-- World Surf League Unisex Official -->
...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "World Surf League Unisex Official";
...
<html>
<title>World Surf League Unisex Official - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals6.jpg" alt="World Surf League Unisex Official" align="left" class="x1-padding-large">
  <h1 class="x1-titles">World Surf League Unisex Official</h1>
  <h4>$32.99</h4>
		<br>
		Our World Surf League Unisex Official sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="World Surf League Unisex Official">
				...
				<select name="os1" id="os1">
					<option value="M7">Mens - 7</option>
					<option value="M8">Mens - 8</option>
					<option value="M9">Mens - 9</option>
					<option value="M10">Mens - 10</option>
					<option value="M11">Mens - 11</option>
					<option value="M12">Mens - 12</option>
					<option value="M13">Mens - 13</option>
					<option value="W5">Womens - 5</option>
					<option value="W6">Womens - 6</option>
					<option value="W7">Womens - 7</option>
					<option value="W8">Womens - 8</option>
					<option value="W9">Womens - 9</option>
					<option value="W10">Womens - 10</option>
					<option value="W11">Womens - 11</option>
					<option value="W12">Womens - 12</option>
				</select>
				...
				<input type="hidden" name="option_amount1" value="32.99">
