...
<html>
<title>Rising Tide 3.0 - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals2.jpg" alt="Rising Tide 3.0" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Rising Tide 3.0</h1>
  <h4>$29.99</h4>
		<br>
		Our Rising Tide 3.0 sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Rising Tide 3.0">
