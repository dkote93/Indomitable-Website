...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "1986 Vintage Casual Sandals";
...
<html>
<title>1986 Vintage Casual Sandals - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals8.jpg" alt="1986 Vintage Casual Sandals" align="left" class="x1-padding-large">
  <h1 class="x1-titles">1986 Vintage Casual Sandals</h1>
  <h4>$34.99</h4>
		<br>
		Our 1986 Vintage Casual Sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="1986 Vintage Casual Sandals">
