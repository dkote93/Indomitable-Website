...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Indomitable Super Grip 1.0";
...
<html>
<title>Indomitable Super Grip 1.0 - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="sandals7.jpg" alt="Indomitable Super Grip 1.0" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable Super Grip 1.0</h1>
  <h4>$19.99</h4>
		<br>
		Our Indomitable Super Grip 1.0 sandals are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable Super Grip 1.0">
