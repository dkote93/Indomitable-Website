...
<html>
<title>Fastback Wires - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="5.jpg" width="45%" alt="Fastback Wires" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Fastback Wires</h1>
  <h4>$130.50</h4>
		<br>
		Our Fastback Wires sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Fastback Wires">
				...
				<input type="hidden" name="option_amount0" value="130.50">
	<br>
	<br>
		Quantity: 
