...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Indomitable Official M4 Ice";
...
<html>
<title>Indomitable Official M4 Ice - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="4.jpg" width="45%" alt="Indomitable Official M4 Ice" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable Official M4 Ice</h1>
  <h4>$169.99</h4>
		<br>
		Our Indomitable Official M4 Ice sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable Official M4 Ice">
				...
				<input type="hidden" name="option_amount0" value="169.99">
	<br>
	<br>
		Quantity: 
