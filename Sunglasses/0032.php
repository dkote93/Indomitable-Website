...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Xgear Military Aviators UVAG";
...
<html>
<title>Xgear Military Aviators UVAG - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="8.jpg" width="45%" alt="Xgear Military Aviators UVAG" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Xgear Military Aviators UVAG</h1>
  <h4>$234.99</h4>
		<br>
		Our Xgear Military Aviators UVAG sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Xgear Military Aviators UVAG">
				...
				<input type="hidden" name="option_amount0" value="234.99">
	<br>
	<br>
		Quantity: 
