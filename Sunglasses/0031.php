...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Vintage Era 100% UV SideKicks";
...
<html>
<title>Vintage Era 100% UV SideKicks - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="7.jpg" width="45%" alt="Vintage Era 100% UV SideKicks" align="left" class="x1-padding-large">
  <!-- image from http://sunglasssunrise.com/images/SideKickMedium44.jpg -->
  <h1 class="x1-titles">Vintage Era 100% UV SideKicks</h1>
  <h4>$124.99</h4>
		<br>
		Our Vintage Era 100% UV SideKicks sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Vintage Era 100% UV SideKicks">
				...
				<select name="os0" id="os0">
					<option value="Select a color scheme"selected>
				...
				<input type="hidden" name="option_select0" value="sunglasses">
				<input type="hidden" name="option_amount0" value="124.99">
	<br>
	<br>
		Quantity: 
