...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "WSL Official Razor 100% UA 3.0";
...
<html>
<title>WSL Official Razor 100% UA 3.0 - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="6.jpg" width="45%" alt="WSL Official Razor 100% UA 3.0" align="left" class="x1-padding-large">
  <h1 class="x1-titles">WSL Official Razor 100% UA 3.0</h1>
  <h4>$116.99</h4>
		<br>
		Our WSL Official Razor 100% UA 3.0 sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="WSL Official Razor 100% UA 3.0">
				...
				<input type="hidden" name="option_amount0" value="116.99">
	<br>
	<br>
		Quantity: 
