<!-- Indomitable David Clark Signature Ed -->
...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Indomitable David Clark Signature Ed";
...
<html>
<title>Indomitable David Clark Signature Ed - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="2.jpg" width="45%" alt="Indomitable David Clark Signature Ed" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable David Clark Signature Ed</h1>
  <h4>$129.99</h4>
		<br>
		Our Indomitable David Clark Signature Ed sunglasses are manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable David Clark Signature Ed">
				...
				<input type="hidden" name="option_amount0" value="129.99">
	<br>
	<br>
		Quantity: 
