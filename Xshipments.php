...
<html>
<title>Indomitabe Clothing and Apparel</title>
<meta charset="UTF-8">
...
<article>
  ...
  <div class="x1-container x1-black x1-padding-32">
    ...
    <button type="button" class="x1-button x1-red x1-margin-bottom">Subscribe</button>
  </div>
  
  <!-- Footer -->
  <footer class="x1-padding-64 x1-light-grey x1-small x1-center" id="footer">
    <div class="x1-row-padding">
      ...
      <div class="x1-col s4">
        <h4>About</h4>
        <p><a href="Xhistory.php">About us</a></p><!--not created-->
        <p><a href="Xcareers.php">Careers</a></p><!--not created-->
        <p><a href="Ifaq.php">Support</a></p><!--not created-->
        <p><a href="Xshipments.php">Shipments</a></p><!--not created-->
        <p><a href="Xpayments.php">Payments</a></p><!--not created-->
        <p><a href="Xreturns.php">Returns</a></p><!--need CSS and adjustments-->
      </div>
      ...
      <div class="x1-col s4 x1-justify">
        ...
        <p><i class="fa fa-fw fa-envelope"></i> IndomitableC&A@mail.com</p>
        <h4>We accept</h4>
