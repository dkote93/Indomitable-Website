...
<html>
<title>Surf Up Limited - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="h2.png" alt="Surf Up Limited" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Surf Up Limited</h1>
  <h4>$29.99</h4>
		<br>
		Our Surf Up Limited cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Surf Up Limited">
