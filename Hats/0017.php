<!-- Snap Back David Clark Limited Edition -->
...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Snap Back David Clark Limited Edition";
...
<html>
<title>Snap Back David Clark Limited Edition - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="h1.png" alt="Snap Back David Clark Limited Edition" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Snap Back David Clark Limited Edition</h1>
  <h4>$29.99</h4>
		<br>
		Our Snap Back David Clark Limited Edition cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Snap Back David Clark Limited Edition">
