...
<html>
<title>World Surf League 1986 - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="h8.png" alt="World Surf League 1986" align="left" class="x1-padding-large">
  <h1 class="x1-titles">World Surf League 1986</h1>
  <h4>$34.99</h4>
		<br>
		Our World Surf League 1986 cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="World Surf League 1986">
				...
				<select name="os0" id="os0">
					<option value="Navy" selected>Navy Blue</option>
