...
<html>
<title>Support Our Military USA - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="h3.png" alt="Support Our Military USA" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Support Our Military USA</h1>
  <h4>$19.99</h4>
		<br>
		Our Support Our Military USA cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Support Our Military USA">
				...
				<select name="os0" id="os0">
					...
					<option value="Camo">Camo (+$3.00)</option>
				...
				<input type="hidden" name="option_select0" value="Camo">
				<input type="hidden" name="option_amount0" value="22.99">
	<br>
	<br>
		Quantity: 
