<!-- Anchors Away Offical WSL Limited -->
...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Anchors Away Offical WSL Limited";
...
<html>
<title>Anchors Away Offical WSL Limited - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="h4.png" alt="Anchors Away Offical WSL Limited" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Anchors Away Offical WSL Limited</h1>
  <h4>$29.99</h4>
		<br>
		Our Anchors Away Offical WSL Limited cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Anchors Away Offical WSL Limited">
