...
<html>
<title>Indomitable Running - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt4.png" alt="Indomitable Running" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable Running</h1>
  <h4>$29.99</h4>
		<br>
		Our Indomitable Running shirt is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable Running">
