...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "World Surf League Polo Unisex";
...
<html>
<title>World Surf League Polo Unisex - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt1.png" alt="World Surf League Polo Unisex" align="left" class="x1-padding-large">
  <h1 class="x1-titles">World Surf League Polo Unisex</h1>
  <h4>$34.99</h4>
		<br>
		Our World Surf League Polo Unisex shirt is manufactured in the U.S. and made by all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="World Surf League Polo Unisex">
