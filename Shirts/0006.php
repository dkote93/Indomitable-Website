...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "HighTech Indomitable Hiker";
...
<html>
<title>HighTech Indomitable Hiker - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt6.png" alt="HighTech Indomitable Hiker" align="left" class="x1-padding-large">
  <h1 class="x1-titles">HighTech Indomitable Hiker</h1>
  <h4>$26.99</h4>
		<br>
		Our HighTech Indomitable Hiker shirt is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="HighTech Indomitable Hiker">
				...
				<input type="hidden" name="option_select0" value="XS">
				<input type="hidden" name="option_amount0" value="26.99">
				<input type="hidden" name="option_select1" value="S">
				<input type="hidden" name="option_amount1" value="26.99">
				<input type="hidden" name="option_select2" value="M">
				<input type="hidden" name="option_amount1" value="26.99">
				<input type="hidden" name="option_select2" value="L">
					<input type="hidden" name="option_amount1" value="26.99">
				<input type="hidden" name="option_select2" value="XL">
					<input type="hidden" name="option_amount1" value="26.99">
				<input type="hidden" name="option_select2" value="XXL">				
				<input type="hidden" name="option_amount1" value="26.99">
	<br>
	<br>
		Quantity: 
