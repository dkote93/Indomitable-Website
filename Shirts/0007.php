...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Vintage Era Indomitable Sweatshirt";
...
<html>
<title>Vintage Era Indomitable Shirt - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt7.png" alt="Vintage Era Indomitable Shirt" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Vintage Era Indomitable Sweatshirt</h1>
  <h4>$54.99</h4>
		<br>
		Our Vintage Era Indomitable Sweatshirt is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Vintage Era Indomitable Sweatshirt">
