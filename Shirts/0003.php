...
<html>
<title>Unisex Savage WSL Hoodie - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt3.png" alt="Unisex Savage WSL Hoodie" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Unisex Savage WSL Hoodie</h1>
  <h4>$49.99</h4>
		<br>
		Our Unisex Savage WSL Hoodie is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Unisex Savage WSL Hoodie">
				<input type="hidden" name="sku" value="0003">
