...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Indomitable New Cotton Shirt";
...
<html>
<title>Indomitable New Cotton Shirt - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt5.png" alt="Indomitable New Cotton Shirt" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable New Cotton Shirt</h1>
  <h4>$29.99</h4>
		<br>
		Our Indomitable New Cotton shirt is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable New Cotton Shirt">
