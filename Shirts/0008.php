...
<html>
<title>Crush-Kill-Destroy-Swag - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt8.png" alt="Crush-Kill-Destroy-Swag" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Crush-Kill-Destroy-Swag</h1>
  <h4>$34.99</h4>
		<br>
		Our Crush-Kill-Destroy-Swag shirt is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Crush-Kill-Destroy-Swag">
