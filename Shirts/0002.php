...
<?php
	...
	if (isset($_POST['addToCart'])) {
		if(isset($_SESSION['logged_in'])){
			...
			$name = "Indomitable V-Neck 100% Cotton";
...
<html>
<title>Indomitable V-Neck 100% Cotton - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<p>
  ...
  <img src="shirt2.png" alt="Indomitable V-Neck 100% Cotton" align="left" class="x1-padding-large">
  <h1 class="x1-titles">Indomitable V-Neck 100% Cotton</h1>
  <h4>$29.99</h4>
		<br>
		Our Indomitable V-Neck 100% Cotton shirt is manufactured in the U.S. and is made with 100% cotton for a comfortable and soft fit.
		<br>
		<br>
			<center><form target="paypal" action="" method="post">
				...
				<input type="hidden" name="item_name" value="Indomitable V-Neck 100% Cotton">
