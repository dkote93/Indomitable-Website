...
<!DOCTYPE html>
<html>
<title>nameeee - Indomitable Clothing and Apparel</title>
<meta charset="UTF-8">
...
<nav class="x1-sidenav x1-white x1-collapse x1-top" style="z-index:3;width:220px" id="mySidenav">
  ...
  <div class="x1-login">
  <a href="Xlogin.php">LOG IN</a></div>
...
<p>
  ...
  <img src="h1.png" alt="nameeee" align="left" class="x1-padding-large">
  <h1 class="x1-titles">nameeee</h1>
  <h4>$priceeee</h4>
		<br>
		Our nameeee cap is manufactured in the U.S. and is made with all natural materials.
		<br>
		<br>
			<center><form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				...
				<input type="hidden" name="item_name" value="nameeee">
				<input type="hidden" name="sku" value="skuuuu">
				...
				<select name="os1" id="os1">
					<option value="Select a Size"selected> - Select a Size -</option>
					<option
						value="Mens size">-- Men's Sizes --</option>
					<option value="7M">Mens - 7</option>
					<option value="8M">Mens - 8</option>
					<option value="9M">Mens - 9</option>
					<option value="10M">Mens - 10</option>
					<option value="11M">Mens - 11</option>
					<option value="12M">Mens - 12</option>
					<option value="13M">Mens - 13</option>
					<option value="Women Sizes"> -- Women's Sizes -- </option>
					<option value="5W">Womens - 5</option>
					<option value="6W">Womens - 6</option>
					<option value="7W">Womens - 7</option>
					<option value="8W">Womens - 8</option>
					<option value="9W">Womens - 9</option>
					<option value="10W">Womens - 10</option>
					<option value="11W">Womens - 11</option>
					<option value="12W">Womens - 12</option>
				</select>

				<!-- Specify the price that PayPal uses for each option. -->
				<input type="hidden" name="option_index" value="1">
				<input type="hidden" name="option_select0" value="7M">
				<input type="hidden" name="option_amount0" value="priceeee">
				<input type="hidden" name="option_select1" value="8M">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="9M">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="10M">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="11M">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="12M">				
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select0" value="13M">
				<input type="hidden" name="option_amount0" value="priceeee">
				<input type="hidden" name="option_select1" value="5W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="6W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="7W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="8W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="9W">				
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="10W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="11W">
				<input type="hidden" name="option_amount1" value="priceeee">
				<input type="hidden" name="option_select2" value="12W">				
				<input type="hidden" name="option_amount1" value="priceeee">
	<br>
	<br>
        ...
        <button class="add-cart">
			<div class="title">Pay via PayPal for quick checkout:</div>
			<div class="price">priceeee</div>
		</button>
