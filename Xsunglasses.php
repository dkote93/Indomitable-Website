...
<div class="x1-main" style="margin-left:250px">
  ...
  <h1 class="x1-titles">Sunglasses</h1>
  ...
  <div class="x1-row x1-grayscale">
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sunglasses/0025.php"><img src="sunglasses/1.jpg" style="width:100%"></a><!--changeimages-->
        <p>World Surf League Polo Unisex<br><b>$134.99</b></p><!--polo1.png-->
      </div>
      <div class="x1-container">
        <a href="sunglasses/0026.php"><img src="sunglasses/2.jpg" style="width:100%"></a>
        <p><i>Indomitable David Clark Signature Ed</i><br><b>$129.99</b></p><!--ishirt1.jpg-->
      </div>
    </div>
    ...
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <div class="x1-display-container">
          <a href="sunglasses/0027.php"><img src="sunglasses/3.jpg" style="width:100%"></a>
          <span class="x1-tag x1-display-topleft">New</span>
        </div>
        <p>Unisex Vapor Sunglasses<br><b>$149.99</b></p>
      </div>
      <div class="x1-container">
        <a href="sunglasses/0028.php"><img src="sunglasses/4.jpg" style="width:100%"></a>
        <p>Indomitable Offical M4 Ice<br><b>$169.99</b></p>
      </div>
    </div>

    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sunglasses/0029.php"><img src="sunglasses/5.jpg" style="width:100%"></a><!--indomitableshirt2-->
        <p>Fastback Wires<br><b>$130.50</b></p>
      </div>
      <div class="x1-container">
        <div class="x1-display-container">
          <a href="sunglasses/0030.php"><img src="sunglasses/6.jpg" style="width:100%"></a>
          <span class="x1-tag x1-display-topleft">Sale</span>
        </div>
        <p>World Surf League Offical Razor 100% UA 3.0<br><b class="x1-text-red">$116.99</b></p>
      </div>
    </div>

    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sunglasses/0031.php"><img src="sunglasses/7.jpg" style="width:100%"></a><!--vintage1.png-->
        <p>Vintage Era 100% UV SideKicks<br><b>$124.99</b></p>
      </div>
      <div class="x1-container">
        <a href="sunglasses/0032.php"><img src="sunglasses/8.jpg" style="width:100%"></a>
        <p>XGear Military Aviators UVAG<br><b>$234.99</b></p>
      </div>
    </div>
  </div>
  <!-- Subscribe section -->
