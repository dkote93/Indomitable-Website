...
<div class="x1-main" style="margin-left:250px">
  ...
  <div class="x1-container x1-text-grey" id="hats">
    <p></p>
  </div>
<!--/ All sandal images were used from this link /https://www.kohls.com/catalog/mens-sandals-shoes.jsp?CN=Gender:Mens+Product:Sandals+Department:Shoes / -->
  <!-- Product grid -->
  <div class="x1-row x1-grayscale">
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sandals/0009.php"><img src="sandals/sandals1.jpg" style="width:100%"></a>
        <p>David Clark Unisex 2017<br><b>$19.99</b></p>
      </div>
      <div class="x1-container">
        <a href="sandals/0010.php"><img src="sandals/sandals2.jpg" style="width:100%"></a>
        <p><i>Rising Tide 3.0</i><br><b>$29.99</b></p>
      </div>
    </div>
    ...
    <div class="x1-col l3 s6">
      <div class="x1-container">
        <div class="x1-display-container">
          <a href="sandals/0011.php"><img src="sandals/sandals3.jpg" style="width:100%"></a>
          <span class="x1-tag x1-display-topleft">New</span>
        </div>
        <p>Rip Tide 2017 "Beach Runner"<br><b>$29.99</b></p>
      </div>
      <div class="x1-container">
        <a href="sandals/0012.php"><img src="sandals/sandals4.jpg" style="width:100%"></a>
        <p>Indomitable Beach Razors<br><b>$9.99</b></p>
      </div>
    </div>

    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sandals/0013.php"><img src="sandals/sandals5.jpg" style="width:100%"></a>
        <p>Expedition Climb Sand Dwellers<br><b>$29.99</b></p>
      </div>
      <div class="x1-container">
        <div class="x1-display-container">
          <a href="sandals/0014.php"><img src="sandals/sandals6.jpg" style="width:100%"></a>
          <span class="x1-tag x1-display-topleft">Sale</span>
        </div>
        <p>Unisex World Surf League Offical<br><b class="x1-text-red">$32.99</b></p>
      </div>
    </div>

    <div class="x1-col l3 s6">
      <div class="x1-container">
        <a href="sandals/0015.php"><img src="sandals/sandals7.jpg" style="width:100%"></a><!--vintage1.png-->
        <p>Indomitable Super Grip 1.0<br><b>$19.99</b></p>
      </div>
      <div class="x1-container">
        <a href="sandals/0016.php"><img src="sandals/sandals8.jpg" style="width:100%"></a>
        <p>1986 Vintage Casual Sandals<br><b>$34.99</b></p>
      </div>
    </div>
  </div>
