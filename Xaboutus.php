...
<div class="x1-main" style="margin-left:250px">
  ...
  <!-- Image header -->
  <div class="x1-display-container x1-container">
  <h1 class="x1-titles">History</h1>
    <img src="" alt="" style="width:100%"><!--no image currently inserted-->
  
<article>
 
<p>Indomitable Clothing and Apparel was founded by David Clark in 1991. David Clark grew up in a small town
on the east side of Miami Florida. As a troubled teen David found himself always in running from the local authorities. It was by chance
he found the outlet that would change his life forever by steeling a surf board off a local beach from legendary surfer Maui Hondi.</p>
<p>

<p>David Clark won numerous surfing competitions during the 70's and 80's. His popularity continued to grow as surfing
became more main stream and televised. It was in 1982 David Clark reached legendary status after riding the largest wave ever recorded.
The Guiness Book of World Records measure the wave at 82.6 feet. Never has anyone dared to chance a wave greater than 80 feet. Numerous spectators
were present to witness the incredible swells. It was on that day David sealed his name as "The Legend" of surfing.</p>
  
<p>Our company strives to deliver the highest quality products at the absolute best prices. Indomitable Clothing and Apparel is determined to
listen to our customers. We continually seek your feedback. 

<p><b>David Clarks WSL Championships</b></p>

<ul>
	<li>1967 Junior Surfing Championships, 1st Place, Northern Hawaii</li>
	<li>1968 Junior Open Games Surf Competition, 2nd Place TopSail Island, NC</li>
	<li>1974, 1975, 1976 - WSL Professional Championships, 1st Place all three years</li>
	<li>1980 World Champion - Presented by Maui Hondi, World Surf League</li>
</ul>
  ...
  <div class="x1-container x1-black x1-padding-32">
    ...
    <p><input class="x1-input x1-border" type="text" placeholder="Enter e-mail" name="Subscribe" style="width:100%"required></p>
...
<div id="newsletter" class="x1-modal">
  <div class="x1-modal-content x1-animate-zoom x1-padding-jumbo">
    <div class="x1-container x1-white x1-center">
      ...
      <p><input class="x1-input x1-border" type="text" name="Newsletter" placeholder="Enter e-mail"required></p>
